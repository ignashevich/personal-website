    ...
    return (
        <main className="grid h-full gap-3 place-content-center place-items-center px-8">
            ...
            <div className="sm:text-2xl flex space-x-2 sm:space-x-6 mb-6 sm:mb-8">
                <a rel="noreferrer" target="_blank" className="text-blue-500 hover:text-gray-400" href="https://docs.google.com/document/d/1S7TfClSn_sQU1VjOiVaRVpX4PXeWa00c6g0zGe39yRc/edit?usp=sharing">Resume</a>
                <a rel="noreferrer" target="_blank" className="text-blue-500 hover:text-gray-400" href="tg://resolve?domain=al_ignashevich">Telegram</a>
                <a rel="noreferrer" target="_blank" className="text-blue-500 hover:text-gray-400" href="https://github.com/ignashevich">Github</a>
                <a rel="noreferrer" target="_blank" className="text-blue-500 hover:text-gray-400" href="https://www.linkedin.com/in/aliaksandr-ihnashevich-775540129/">Linkedin</a>
            </div>
